#ifndef AHORN_ETFA_CONTEXT_H
#define AHORN_ETFA_CONTEXT_H

#include "se/etfa/context/frame.h"
...
namespace se::etfa {
    ...
    public:
        ...
        std::unique_ptr<Context> fork(const Vertex &vertex, const z3::expr &expression) const;
