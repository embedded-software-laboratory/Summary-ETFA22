#ifndef AHORN_ETFA_NO_MERGE_STATE_H
#define AHORN_ETFA_NO_MERGE_STATE_H
...
namespace se::etfa_no_merge {
    ...
    public:
        ...
        std::unique_ptr<State> fork(const Vertex &vertex, const z3::expr &expression, z3::model &model) const;
...
#endif//AHORN_ETFA_NO_MERGE_STATE_H
